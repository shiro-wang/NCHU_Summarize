public class HW11_4108056004_1 extends GroupCounting{
    public HW11_4108056004_1(){
    }
    public static void main(String args[]){
        String [] A = {"A","B","B","C","B","D","F","G","A","1232131332","A","A","A","A","A","A","A","A","A","A","A","A","A","A","A"};
        String [] B = {"E","E","C","D","D","E","H","H","Asceqdsa","198638752","A23432","A5234","A98765","A35","A853","A4362","A856","A2464","A9766","A111","A222","A3333","A444","A555","A66"};
        HW11_4108056004_1 test = new HW11_4108056004_1();
        
        int final_ans = test.count(A, B);
        System.out.println(final_ans);
    }
    static public int c = 10000;
    ...
    class ChinaQueue
    {
        ...
        {
            String[] newarray = new String[MAX_QUEUE_SIZE*2];
            for(int i=head;i<MAX_QUEUE_SIZE;i++){
                newarray[i+MAX_QUEUE_SIZE]=array[i];
            }
